                        ...
                        <div class="card p-4">
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    <img src="<?php echo '../app/' . $admin['photo_profile_path']; ?>" alt="avatar" style="width: 80px; height: 80px;">
                                </div>
                                <div class="mb-3 text-center">
                                    <form method="POST" action="/sibeta/public/index.php?page=change_profile_photo&id=<?= $admin['UserID']; ?>" enctype="multipart/form-data" id="changePhotoForm">
                                ...
                                <form method="POST" action="/sibeta/public/index.php?page=super_admin/change_staff_profile&id=<?= $admin['UserID']; ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name = "nip" class="form-control" id="nip" value="<?= $admin['NIP']; ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="role" class="form-label">Role</label>
                                        <input type="text" name = "role" class="form-control" id="role" value="<?= $admin['RoleName']; ?>">
                                    </div>
                                    <div class="text-end">
                    ...
                    <div class="col-md-6">
                        <div class="card p-4">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/sibeta/public/index.php?page=super_admin/update_password_staff&id=<?= $admin['UserID']; ?>" id="passwordForm" onsubmit="return validatePassword()">
